package tech.laye.ecommerce.email;
...
import tech.laye.ecommerce.kafka.order.Product;
...
public class EmailService {
    ...
    public void sentPaymentSuccessEmail(
        ...
        messageHelper.setFrom("coding@laye.com");
        ...
        try{
            ...
            log.warn("WARNING - failed to send email to {}",destinationEmail);
        }
    }
